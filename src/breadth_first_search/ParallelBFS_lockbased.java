...
public class ParallelBFS_lockbased implements BreadthFirstSearch {
	...
	public ParallelBFS_lockbased(Graph graph, int num_Threads) {
		...
		n_threads_waiting = new SyncCounter();
	}
...
//		System.out.println("Starting threads");
        ...
        waitingLock.lock();
        try {
        	while (n_threads_waiting.getCount() != n_threads) {
        		try {
	...
	public class BFSThread extends Thread {
		...
		public BFSThread(Queue<Integer> current, Queue<Integer> next, CyclicBarrier barrier, int n_threads, SyncCounter n_threads_waiting, ReentrantLock waitingLock, Condition allThreadsWaiting) {
